...
<ul class="navbar-nav bg-gradient-primary sidebar sidebar-dark accordion" id="accordionSidebar">
	...
	<a class="sidebar-brand d-flex align-items-center justify-content-center" href="index.php">
		<div class="sidebar-brand-icon rotate-n-15">
			<img src="img/kawag.jpg" class="img-thumbnail">
		</div>
		<div class="sidebar-brand-text mx-3">KAWAG</div>
	</a>
	...
	<li class="nav-item">
		...
		<div id="collapseTwo" class="collapse" aria-labelledby="headingTwo" data-parent="#accordionSidebar"> <!-- Todos deben tener  acceso a las ventas, para que el supervisor y vendedor vean las ventas. -->
	...
	<?php if ($_SESSION['rol'] == 1) { ?> <!-- Solo el ROL del administrador tiene acceso a esto -->
	...
	<?php } ?>
	<!-- Nav Item - Utilities Collapse Menu WF -->
	<?php if ($_SESSION['rol'] == 1) { ?> <!-- Solo el ROL del administrador tiene acceso a esto -->
	<li class="nav-item">
	...
	<li class="nav-item">
		<a class="nav-link collapsed" href="#" data-toggle="collapse" data-target="#collapseGestion" aria-expanded="true" aria-controls="collapseUtilities">
			<i class="fas fa-fw fa-Gestion"></i>
			<span> Gestión Documental </span>
		</a>
		<div id="collapseGestion" class="collapse" aria-labelledby="headingUtilities" data-parent="#accordionSidebar">
			<div class="bg-white py-2 collapse-inner rounded">
				<a class="collapse-item" href="cargardoc.php"> Soportes Documentales </a>

<head>
	<meta charset="UTF-8">
	<title>Registrar Proveedor | KAWAG </title>
</head>
        ...
        <div class="col-lg-6 m-auto">
            ...
            <div class="card">
                <form action="" autocomplete="off" method="post" class="card-body p-2">
                    ...
                    <div class="form-group">
                        <label for="contacto">NIT o CÉDULA </label>
                        <input type="text" placeholder="Ingrese NIT o Cédula" name="contacto" id="contacto" class="form-control">
                    </div>
                    <div class="form-group">
